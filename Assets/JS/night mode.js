/* =========================================================
   night-mode.js — Theme toggle (day ↔ night)
...
(function initThemeToggle() {
    ...
    var MOON_SVG =
        ...
        'fill="#8899ee" stroke="#8899ee" stroke-width="1">' +
    ...
    function applyTheme(night) {
        ...
        try {
            sessionStorage.setItem('ib-theme', night ? 'night' : 'day');
        } catch (e) { /* storage unavailable — ignore */ }
    }
    ...
    /* ── Placement logic ────────────────────────────────── */
    /*
     * Mobile:  move toggle + hamburger into a flex group on the right
     *          side of the pill-nav bar.
     * Desktop: attach directly to body as a fixed button.
     */
    function placeToggle() {
        ...
        if (isMobile) {
            ...
            /* Restore burger to nav and detach the group */
            ...
            /* Append toggle to body as a fixed button */
    ...
    /* ── Initialise after PillNav has rendered ──────────── */
    ...
    /* ── Re-place on viewport resize (only on breakpoint cross) */
